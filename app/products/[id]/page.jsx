...
import { ChevronLeft, ChevronRight, Heart, Bookmark, Share2, Star, ShoppingBag, Truck, RotateCcw } from "lucide-react"
import { Button } from "@/components/ui/button"
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group"
import { Label } from "@/components/ui/label"

export default function EmbraceProductEnhanced() {
        ...
        <div className="space-y-4 lg:space-y-5 order-2 lg:order-2">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex-1">
              <h1 className="text-xl sm:text-2xl font-semibold text-foreground mb-1">Embrace Sideboard</h1>
              <p className="text-muted-foreground">Teixeira Design Studio</p>
            </div>
          </div>
