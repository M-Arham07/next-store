...
import { z } from "zod";
/* CUSTOM SCHEMA TO VALIDATE CART PRODUCT OBJECTS, SO APP DOESENT CRASHES AT RUNTIME
...
export default function ValidateCartProducts(Products) {




   return Products.every((product,index,arr)=>cartproductSchema.safeParse(product).success 
